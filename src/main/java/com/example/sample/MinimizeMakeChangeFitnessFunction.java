 ...
 */
public class MinimizeMakeChangeFitnessFunction extends FitnessFunction
{
    /**
	 * Serial version ID
	 */
    ...
    /**
     * Constructs this MinimizeMakeChangeFitnessFunction with the desired
     ...
     */
    public MinimizeMakeChangeFitnessFunction( int a_targetAmount )
    {
